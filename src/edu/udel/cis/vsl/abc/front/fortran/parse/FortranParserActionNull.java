...
public class FortranParserActionNull implements IFortranParserAction {
	...
	public FortranParserActionNull(String[] args, IFortranParser parser, String filename) {
		super();
	}
...
@Override
public void do_term_action_stmt(Token label, Token endKeyword, Token doKeyword,
		Token id, Token eos) {
