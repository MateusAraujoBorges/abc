...
public abstract class AbstractFortranParser extends Parser
		implements IFortranParser {

	/*
	 * Provide action objects to implement the AST. These are singleton objects.
	 */
	protected static IFortranParserAction action = null;
	protected static IFortranParserAction nullAction = new FortranParserActionNull(
			null, null, null);
	...
	protected AbstractFortranParser(TokenStream input,
	...
	public void initialize(AbstractFortranParser delegate,
			IFortranParserAction action, String filename, String path) {
	...
	/**
	 * Check for include and end of file. T_INCLUDE is not in the grammar so
	 * this method must be called after every statement (and initially at the
