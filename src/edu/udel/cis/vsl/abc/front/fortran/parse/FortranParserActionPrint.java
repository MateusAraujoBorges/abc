...
public class FortranParserActionPrint implements IFortranParserAction {
	...
	FortranParserActionPrint(String[] args, IFortranParser parser,
			String filename) {
		super();
	}
	...
	private void printParameter(Token param, String name) {
		...
		if (verbose) {
			...
			if (param != null)
				System.out.print(param.getText());
			else
	...
	/**
	 * R405 signed_int_literal_constant
	 */
	...
	/**
	 * R416 signed_real_literal_constant
	 */
	...
	/**
	 * R429 type_param_or_comp_def_stmt
	 */
	...
	/**
	 * R429 type_param_or_comp_def_stmt_list
	 */
	...
	/**
	 * R431 list type_attr_spec type_attr_spec_list
	 */
	...
	/**
	 * R436 list type_param_decl type_param_decl_list
	 */
	...
	public void component_decl(Token id, boolean hasComponentArraySpec,
		...
		printParameter(hasComponentInitialization,
				"hasComponentInitialization");
		printRuleTrailer();
	}

	/**
	 * R438-F08 list component_decl component_decl_list
	 */
	...
	/**
	 * R443 list deferred_shape_spec_list
	 */
	...
	/**
	 * R446 list proc_component_attr_spec_list
	 */
	...
	/**
	 * R448 type_bound_procedure_part
	 */
	...
	/**
	 * R456 list type_param_spec_list
	 */
	...
	/**
	 * R503-F08 list entity_decl_list
	 */
	...
	/**
	 * R511 list explicit_shape_spec explicit_shape_spec_list
	 */
	...
	/**
	 * R527-F08 list allocatable_decl_list
	 */
	...
	/**
	 * R523 list bind_entity bind_entity_list
	 */
	...
	/**
	 * R532-F08 list codimension_decl codimension_decl_list
	 */
	...
	/**
	 * R526 list data_stmt_object_list
	 */
	...
	/**
	 * R528 list data_i_do_object_list
	 */
	...
	/**
	 * R530 list data_stmt_value_list
	 */
	...
	/**
	 * R509-F2008 dimension_spec
	 *
	 * @param dimensionKeyword
	 *            T_DIMENSION token.
	 */
	...
	/**
	 * R539 list named_constant_def_list
	 */
	...
	/**
	 * R540-extension cray_pointer_stmt
	 */
	...
	/**
	 * R541-extension list cray_pointer_assoc_list
	 */
	...
	/**
	 * R541-extension cray_pointer_assoc
	 */
	...
	/**
	 * R557-F08 list target_decl_list
	 */
	...
	/**
	 * R553 list namelist_group_object_list
	 */
	...
	/**
	 * R555 list equivalence_set_list
	 */
	...
	/**
	 * R556 list equivalence_object_list
	 */
	...
	/**
	 * R558 list common_block_object_list
	 */
	...
	/**
	 * Unknown rule. designator_or_func_ref
	 */
	...
	/**
	 * Unknown rule. substring_range_or_arg_list
	 */
	...
	/**
	 * Unknown rule. substr_range_or_arg_list_suffix
	 */
	...
	/**
	 * Unknown rule. scalar_default_logical_variable
	 */
	...
	/**
	 * Unknown rule. scalar_default_char_variable
	 */
	...
	/**
	 * R613, R613-F2008 part_ref
	 */
	public void part_ref(Token id, boolean hasSectionSubscriptList,
	...
	/**
	 * R619 list section_subscript section_subscript_list
	 */
	...
	/**
	 * R629 list allocate_object_list
	 */
	...
	/**
	 * R630 list allocate_shape_spec_list
	 */
	...
	/**
	 * R637-F08 list allocate_coshape_spec_list
	 */
	public void allocate_coshape_spec_list__begin() {
		printRuleHeader(637008, "allocate-coshape-spec-list__begin",
				"list-begin");
		printRuleTrailer();
	}
	...
	/**
	 * R704: note, inserted as R704 functionality power_operand
	 */
	...
	/**
	 * R704: note, see power_operand mult_operand
	 */
	...
	/**
	 * R715: note, moved leading optional to or_operand or_operand
	 */
	...
	/**
	 * R738 list bounds_remapping_list
	 */
	...
	/**
	 * R755 list forall_triplet_spec_list
	 */
	...
	public void end_critical_stmt(Token label, Token id, Token endKeyword,
		...
		if (printKeywords)
			printParameter(endKeyword, "endKeyword");
		if (printKeywords)
			printParameter(criticalKeyword, "criticalKeyword");
		if (printKeywords)
			printParameter(eos, "eos");
		printRuleTrailer();
	}
	...
	/**
	 * R814 list case_value_range_list
	 */
	...
	/**
	 * Unknown rule. case_value_range_suffix
	 */
	 ...
	 */
	public void loop_control(Token whileKeyword, int doConstructType,
			boolean hasOptExpr) {
	...
	public void connect_spec(Token id) {
		...
		if (id != null)
			printParameter(id, "connect-spec");
		printRuleTrailer();
	}

	/**
	 * R905 list connect_spec_list
	 */
	...
	public void close_spec(Token closeSpec) {
		printRuleHeader(721, "equiv-op");
		if (closeSpec != null)
			printParameter(closeSpec, "closeSpec");
		printRuleTrailer();
	}

	/**
	 * R909 list close_spec_list
	 */
	...
	/**
	 * R913 list io_control_spec_list
	 */
	...
	/**
	 * R1112 only : generic-spec | only-use-name (added in F2008) | rename
	 *
	 * @param hasGenericSpec
	 *            true if generic-spec option is taken
	 * @param hasRename
	 *            true if rename option is taken
	 * @param hasOnlyUseName
	 *            true if only-use-name option is taken
	 */
	...
	public void submodule_stmt(Token label, Token submoduleKeyword, Token name,
		...
		if (label != null)
			printParameter(label, "label");
		if (printKeywords)
			printParameter(submoduleKeyword, "submoduleKeyword");
		printParameter(name, "name");
		if (printKeywords)
			printParameter(eos, "eos");
		printRuleTrailer();
	...
	public void end_interface_stmt(Token label, Token kw1, Token kw2, Token eos,
		...
		if (label != null)
			printParameter(label, "label");
		if (printKeywords)
			printParameter(kw1, "keyword1");
		if (printKeywords)
			printParameter(kw2, "keyword2");
		if (printKeywords)
			printParameter(eos, "eos");
		printParameter(hasGenericSpec, "hasGenericSpec");
		printRuleTrailer();
	...
	/**
	 * R1216 intrinsic_stmt
	 *
	 * @param label
	 *            The label.
	 * @param intrinsicKeyword
	 *            T_INSTRINSIC token.
	 * @param eos
	 *            T_EOS token.
	 */
	...
	/**
	 * R1220 list actual_arg_spec_list
	 */
	...
	public void inclusion(String included, String source) {
		printRuleHeader(unknownRule, "include_stmt");
		if (included != null)
			printParameter(included, "includedFile: ");
		if (source != null)
			printParameter(source, "sourceFile: ");
		printRuleTrailer();
	}
