...
public abstract interface IFortranParserAction {
    ...
    *   |   T_ASTERISK char_length (T_COMMA)?
    *
    * @param len T_LEN token if given; null otherwise.
    ...
    * @param label The label.
    * @param eos T_EOS token.
    * @param hasSpec Boolean true if has a component_attr_spec(_list).
    */
   public abstract void
    ...
    * @param hasBindingAttrList True if has a binding-attr-list.
    */
   public abstract void
    ...
    *
    * @param id Identifier.
    * @param isCommonBlockName True if identifier is a common block name.
    */
    ...
    *
    * @param label The label.
    * @param deallocateKeyword T_DEALLOCATE token.
    * @param eos T_EOS token.
    ...
    *  
    *  @param numMultOps The number of optional mult_ops
    */
    ...
    * @param forallKeyword T_FORALL if given, otherise null.
    ...
    *
    * @param label The label.
    * @param abstractToken The ABSTRACT keyword token (null if the
    ...
    *
    * @param label The label.
    * @param intrinsicToken T_INSTRINSIC token.
    * @param eos T_EOS token.
    */
   public abstract void
