...
public class PreprocessorTokenSource implements CivlcTokenSource {
	 ...
	 * 
	 * @param pragmaNode
	 *            A <code>#pragma</code> node in the preprocessor tree
	 * @throws PreprocessorException
	 *             should not happen
	 */
	 ...
	 * 
	 * @throws PreprocessorException
	 *             if the strings cannot be concatenated for some reason
	 */
	 ...
	 * @throws PreprocessorException
	 *             if something goes wrong concatenating strings or forming a
	 *             character
	 */
