...
public interface Preprocessor {
	 ...
	 * @param indexer
	 *            the file indexer responsible for indexing all source files
	 *            encountered by this ABC session
	 * @param sourceFiles
	...
	// /**
	// * Returns a lexer for the given preprocessor source file. The lexer
	// removes
	...
	// /**
	// * Prints the results of lexical analysis of the source file. Mainly
	// useful
	// * for debugging.
	// *
	// * @param out
	...
	// * @param file
	// * a preprocessor source file sequence
	// * @throws PreprocessorException
	// * if the file fails to adhere to the preprocessor grammar, or
	// * an I/O occurs
	// */
	// void printOutputTokens(File[] systemIncludePaths, File[]
	// userIncludePaths,
	// Map<String, String> implicitMacros, PrintStream out, File[] files)
	// throws PreprocessorException;
	//
	// /**
	...
	// /**
	// * Returns the set of all source files processed by this preprocessor
	// since
	// * creation, including those that have been included through preprocessor
	// * directives, recursively. Each file is assigned an index, numbered from
	// 0,
	...
	// /**
	// * Returns the instance of {@link SourceFile} held by this preprocessor
	// for
	...
	// /**
	// * Returns the number of source files encountered by this preprocessor
	// since
	// * creation.
	// *
	...
	// /**
	// * Returns the index-th {@link SourceFile} object held by this
	// preprocessor.
	// *
	// * @param index
